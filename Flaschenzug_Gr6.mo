package Flaschenzug_Gr6
  package Connectoren
    connector SeilConnect
      ...
      annotation(
        Icon(graphics = {Ellipse(fillColor = {0, 85, 255}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-98, 98}, {98, -98}}, endAngle = 360), Text(origin = {-44, 35}, extent = {{-52, 33}, {146, -97}}, textString = "nGes = %nGes")}, coordinateSystem(initialScale = 0.1)));
    end SeilConnect;
  ...
  model Rolle
    Flaschenzug_Gr6.Connectoren.SeilConnect seilConnect1 annotation(
      Placement(visible = true, transformation(origin = {-70, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-58, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  model Rolle2
  Flaschenzug_Gr6.Connectoren.SeilConnect seilConnect1 annotation(
      Placement(visible = true, transformation(origin = {-36, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-34, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Flaschenzug_Gr6.Connectoren.SeilConnect seilConnect2 annotation(
      Placement(visible = true, transformation(origin = {-24, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {30, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Flaschenzug_Gr6.Connectoren.SeilConnect seilConnect3 annotation(
      Placement(visible = true, transformation(origin = {-12, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  
  parameter Integer n = 1;
  //Modelica.SIunits.Length h;
  //Modelica.SIunits.Velocity v1,v2,v3;
  
  
  equation
//Seilkraft aus 3 an 1 und 2 weitergeben
    seilConnect3.Fz = seilConnect1.Fz;
    seilConnect3.Fz = seilConnect2.Fz;
//Anzahl Rollen aus 1 und 2 addieren und an 3 weitergeben
    seilConnect1.nGes + seilConnect2.nGes = seilConnect3.nGes;
//  seilConnect1.nGes2 + seilConnect2.nGes2 = seilConnect3.nGes2;
//  seilConnect3.nGes = n;
//  seilConnect3.nGes2  = n;
//Gleichsetzen der Seilgeschwindigkeiten
  //  der(seilConnect1.s) = v1;
  //  der(seilConnect2.s) = v2;
  //  der(seilConnect3.s) = v3;
    seilConnect1.s = seilConnect2.s;
...
//v2 = v3;
  ...
  protected
  annotation(
      Icon(graphics = {Ellipse(origin = {0, 34}, fillColor = {204, 204, 204}, fillPattern = FillPattern.Solid, extent = {{30, 16}, {-30, -44}}, endAngle = 360), Text(origin = {1, 19}, extent = {{-17, 7}, {17, -7}}, textString = "n = %n"), Text(origin = {1, 4}, extent = {{-11, 12}, {11, -12}}, textString = "3"), Text(origin = {-35, 35}, extent = {{-7, 7}, {7, -7}}, textString = "1"), Text(origin = {33, 35}, extent = {{-7, 7}, {7, -7}}, textString = "2")}, coordinateSystem(initialScale = 0.1)));
  end Rolle2;
...
//Gewichtskraft Fg = m*g = n*Fz
  ...
  model Decke
    Flaschenzug_Gr6.Connectoren.SeilConnect seilConnect1 annotation(
      Placement(visible = true, transformation(origin = {2, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {2, 68}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    
  //  Real n = 1; // if abs(seilConnect1.nGes) < 1 then 1 else abs(seilConnect1.nGes);
  //  Modelica.SIunits.Velocity v;
      Modelica.SIunits.Length h;
     Modelica.SIunits.Force Fgz "Seilgegenkraft";
...
//  seilConnect1.nGes = 0;
    annotation(
      Icon(graphics = {Line(origin = {-1, 80}, points = {{-65, 0}, {65, 0}}, thickness = 3, arrowSize = 7), Line(origin = {-67.21, 86.21}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {-53.4898, 86.7403}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {-39.7696, 87.2706}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {-26.0494, 86.4481}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {-13.682, 86.6402}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {-1.31458, 87.1705}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {15.1113, 86.348}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {29.8461, 86.5401}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {43.9045, 87.0704}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5), Line(origin = {56.2719, 86.5861}, points = {{-4.79289, 5.79289}, {5.20711, -4.20711}}, thickness = 1.5)}));
  end Decke;
...
//M_L * seilPort1.w - F_z * v =0;
  ...
  Flaschenzug_Gr6.Rolle2 rolle21 annotation(
        Placement(visible = true, transformation(origin = {-2, 12}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
  Flaschenzug_Gr6.Decke decke1 annotation(
        Placement(visible = true, transformation(origin = {55, 69}, extent = {{-27, -27}, {27, 27}}, rotation = 0)));
  Masse masse1 annotation(
        Placement(visible = true, transformation(origin = {-2, -16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(seiltrommel1.seilConnect1, rolle21.seilConnect1) annotation(
        Line(points = {{-52, 42}, {-12, 42}, {-12, 18}, {-12, 18}}));
      connect(rolle21.seilConnect2, decke1.seilConnect1) annotation(
        Line(points = {{8, 18}, {8, 53.5}, {56, 53.5}, {56, 87}}));
      connect(rolle21.seilConnect3, masse1.seilConnect1) annotation(
        Line(points = {{-2, 18}, {-2, 18}, {-2, -8}, {-2, -8}}));
      connect(motor1.seilPort1, seiltrommel1.seilPort1) annotation(
        Line(points = {{-64, 52}, {-46, 52}, {-46, 54}, {-46, 54}}));
      connect(spannungsquelle1.spannungsport1, motor1.spannungsport1) annotation(
        Line(points = {{-84, 52}, {-78, 52}, {-78, 52}, {-78, 52}}));
    end Rolle_2_Test;
  end Modelle;
