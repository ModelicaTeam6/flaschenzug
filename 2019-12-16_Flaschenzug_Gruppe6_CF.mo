...
// Weitergabe von Variablen zwischen Seiltrommel und Masse
  ...
  package Modelle "Beispielhafte Modelle des Flaschenzugs"
    ...
    model xx
      ...
      Flaschenzug_Komponenten.Antrieb.Antrieb_Komponenten.Seiltrommel seiltrommel1(r = 0.1, s_max = 4)  annotation(
        Placement(visible = true, transformation(origin = {-8, 18}, extent = {{-8.5, -8.5}, {8.5, 7.7}}, rotation = 0)));
      Flaschenzug_Komponenten.Antrieb.Antrieb_Komponenten.Spannungsquelle spannungsquelle1 annotation(
        Placement(visible = true, transformation(origin = {-70, 18}, extent = {{-8, -7.3}, {8, 7.3}}, rotation = 0)));
    ...
    equation
      ...
      connect(spannungsquelle1.SpannungsPort1, motor1.SpannungsPort1) annotation(
        Line(points = {{-64, 18}, {-44, 18}, {-44, 14}, {-44, 14}}));
    end xx;
    annotation(
